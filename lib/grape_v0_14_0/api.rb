module GrapeV0_14_0
  # The API class is the primary entry point for creating GrapeV0_14_0 APIs. Users
  # should subclass this class in order to build an API.
  class API
    include GrapeV0_14_0::DSL::API
    ...
    class << self
      ...
      # This is the interface point between Rack and GrapeV0_14_0; it accepts a request
    ...
    def call(env)
      ...
      result[1].delete(GrapeV0_14_0::Http::Headers::X_CASCADE) unless cascade?
      result
    end
        ...
        without_versioning do
          methods_per_path.each do |path, methods|
            ...
            unless self.class.namespace_inheritable(:do_not_route_head)
              allowed_methods |= [GrapeV0_14_0::Http::Headers::HEAD] if allowed_methods.include?(GrapeV0_14_0::Http::Headers::GET)
            end

            allow_header = ([GrapeV0_14_0::Http::Headers::OPTIONS] | allowed_methods).join(', ')
            unless self.class.namespace_inheritable(:do_not_route_options)
              unless allowed_methods.include?(GrapeV0_14_0::Http::Headers::OPTIONS)
            ...
            not_allowed_methods << GrapeV0_14_0::Http::Headers::OPTIONS if self.class.namespace_inheritable(:do_not_route_options)
