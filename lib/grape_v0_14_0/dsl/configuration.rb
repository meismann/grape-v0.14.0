  ...
  module DSL
    module Configuration
      ...
      module ClassMethods
        ...
        # @option options :entity [GrapeV0_14_0::Entity] the entity returned upon a
        ...
        def desc(description, options = {}, &config_block)
          if block_given?
            config_class = GrapeV0_14_0::DSL::Configuration.desc_container
      ...
      def desc_container
        Module.new do
          include GrapeV0_14_0::Util::StrictHashConfiguration.module(
            :description,
            :detail,
            :params,
            :entity,
