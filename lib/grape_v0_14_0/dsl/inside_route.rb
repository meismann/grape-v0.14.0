...
module GrapeV0_14_0
  module DSL
    module InsideRoute
      ...
      def version
        env[GrapeV0_14_0::Env::API_VERSION]
      end
      ...
      def redirect(url, options = {})
        ...
        if permanent
          ...
          if env[GrapeV0_14_0::Http::Headers::HTTP_VERSION] == 'HTTP/1.1' && request.request_method.to_s.upcase != GrapeV0_14_0::Http::Headers::GET
            status 303
      ...
      def status(status = nil)
        ...
        when nil
          ...
          when GrapeV0_14_0::Http::Headers::POST
            201
          else
            200
          end
      ...
      def content_type(val = nil)
        if val
          header(GrapeV0_14_0::Http::Headers::CONTENT_TYPE, val)
        else
          header[GrapeV0_14_0::Http::Headers::CONTENT_TYPE]
        end
      end
      ...
      def file(value = nil)
        if value
          @file = GrapeV0_14_0::Util::FileResponse.new(value)
        else
          @file
        end
      end
      ...
      # Allows you to make use of GrapeV0_14_0 Entities by setting
      ...
      #   end
      def route
        env[GrapeV0_14_0::Env::RACK_ROUTING_ARGS][:route_info]
      end
      ...
      def entity_class_for_obj(object, options)
        ...
        if entity_class.nil?
          ...
          object_class.ancestors.each do |potential|
            entity_class ||= (GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:representations)) || {})[potential]
          end
