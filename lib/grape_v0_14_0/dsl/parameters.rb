...
module GrapeV0_14_0
  module DSL
    ...
    module Parameters
      ...
      #     end
      def use(*names)
        named_params = GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(@api.namespace_stackable(:named_params)) || {}
      ...
      #   passing it to the endpoint. See {GrapeV0_14_0::Validations::Types} for a list of
      ...
      #   options, like that returned by {GrapeV0_14_0::Entity#documentation}. The value
      ...
      def optional(*attrs, &block)
        ...
        if attrs && block_given?
          fail GrapeV0_14_0::Exceptions::MissingGroupTypeError.new if type.nil?
          fail GrapeV0_14_0::Exceptions::UnsupportedGroupTypeError.new unless [Array, Hash].include?(type)
        end
      ...
      #   validations
      # @raise GrapeV0_14_0::Exceptions::UnknownParameter if `attr` has not been
      #   defined in this scope yet
      # @yield a parameter definition DSL
      def given(attr, &block)
        fail GrapeV0_14_0::Exceptions::UnknownParameter.new(attr) unless declared_param?(attr)
