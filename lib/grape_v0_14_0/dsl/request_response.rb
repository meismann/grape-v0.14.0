      ...
      module ClassMethods
        ...
        def format(new_format = nil)
          if new_format
            ...
            namespace_inheritable(:default_error_formatter, GrapeV0_14_0::ErrorFormatter::Base.formatter_for(new_format, {}))
            # define a single mime type
            mime_type = content_types[new_format.to_sym]
            fail GrapeV0_14_0::Exceptions::MissingMimeType.new(new_format) unless mime_type
        ...
        def default_error_formatter(new_formatter_name = nil)
          if new_formatter_name
            new_formatter = GrapeV0_14_0::ErrorFormatter::Base.formatter_for(new_formatter_name, {})
        ...
        def content_types
          c_types = GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:content_types))
          GrapeV0_14_0::ContentTypes.content_types_for c_types
        end
        ...
        #     class ExampleAPI < GrapeV0_14_0::API
        ...
        #   end
        #
        # Note that GrapeV0_14_0 will automatically go up the class ancestry to
        ...
        def represent(model_class, options)
          fail GrapeV0_14_0::Exceptions::InvalidWithOptionForRepresent.new unless options[:with] && options[:with].is_a?(Class)
