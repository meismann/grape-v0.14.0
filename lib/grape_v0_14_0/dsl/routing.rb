      ...
      module ClassMethods
        ...
        def version(*args, &block)
          if args.any?
            ...
            fail GrapeV0_14_0::Exceptions::MissingVendorOption.new if options[:using] == :header && !options.key?(:vendor)
        ...
        def mount(mounts)
          ...
          mounts.each_pair do |app, path|
            ...
            endpoints << GrapeV0_14_0::Endpoint.new(
              in_setting,
              method: :any,
              path: path,
              app: app,
        ...
        def route(methods, paths = ['/'], route_options = {}, &block)
          endpoint_options = {
            ...
            for: self,
            route_options: ({
              params: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:params)) || {}
            }).deep_merge(route_setting(:description) || {}).deep_merge(route_options || {})
          }

          new_endpoint = GrapeV0_14_0::Endpoint.new(inheritable_setting, endpoint_options, &block)
