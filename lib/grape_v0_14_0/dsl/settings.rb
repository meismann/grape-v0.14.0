  ...
  module DSL
    ...
    module Settings
      ...
      def top_level_setting
        @top_level_setting ||= GrapeV0_14_0::Util::InheritableSetting.new
      end
      ...
      def inheritable_setting
        @inheritable_setting ||= GrapeV0_14_0::Util::InheritableSetting.new.tap { |new_settings| new_settings.inherit_from top_level_setting }
      end
      ...
      def namespace_start
        @inheritable_setting = GrapeV0_14_0::Util::InheritableSetting.new.tap { |new_settings| new_settings.inherit_from inheritable_setting }
      end
