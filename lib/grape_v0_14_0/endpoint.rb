module GrapeV0_14_0
  ...
  class Endpoint
    ...
    def require_option(options, key)
      fail GrapeV0_14_0::Exceptions::MissingOption.new(key) unless options.key?(key)
    end
    ...
    def mount_in(route_set)
      if endpoints
        ...
        routes.each do |route|
          ...
          if !namespace_inheritable(:do_not_route_head) && route.route_method == GrapeV0_14_0::Http::Headers::GET
            methods << GrapeV0_14_0::Http::Headers::HEAD
          end
    ...
    def call!(env)
      env[GrapeV0_14_0::Env::API_ENDPOINT] = self
      @env = env
      @app.call(env)
    end

    # Return the collection of endpoints within this endpoint.
    # This is the case when an GrapeV0_14_0::API mounts another GrapeV0_14_0::API.
    def endpoints
    ...
    def run
      ActiveSupport::Notifications.instrument('endpoint_run.grape', endpoint: self, env: env) do
        ...
        route_setting(:saved_validations).each do |validator|
          ...
          rescue GrapeV0_14_0::Exceptions::Validation => e
            validation_errors << e
          end
        end

        if validation_errors.any?
          fail GrapeV0_14_0::Exceptions::ValidationErrors, errors: validation_errors, headers: header
        end
    ...
    def build_stack
      ...
      b.use GrapeV0_14_0::Middleware::Error,
            ...
            content_types: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:content_types)),
            default_status: namespace_inheritable(:default_error_status),
            rescue_all: namespace_inheritable(:rescue_all),
            default_error_formatter: namespace_inheritable(:default_error_formatter),
            error_formatters: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:error_formatters)),
            rescue_options: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:rescue_options)) || {},
            rescue_handlers: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:rescue_handlers)) || {},
            base_only_rescue_handlers: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:base_only_rescue_handlers)) || {},
      ...
      if namespace_inheritable(:version)
        b.use GrapeV0_14_0::Middleware::Versioner.using(namespace_inheritable(:version_options)[:using]),
      ...
      b.use GrapeV0_14_0::Middleware::Formatter,
            format: namespace_inheritable(:format),
            default_format: namespace_inheritable(:default_format) || :txt,
            content_types: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:content_types)),
            formatters: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:formatters)),
            parsers: GrapeV0_14_0::DSL::Configuration.stacked_hash_to_hash(namespace_stackable(:parsers))

      b.run ->(env) { env[GrapeV0_14_0::Env::API_ENDPOINT].run }
