...
require 'grape_v0_14_0/middleware/versioner/parse_media_type_patch'
    ...
    module Versioner
      ...
      class Header < Base
        ...
        def media_type_header_handler
          ...
          env[GrapeV0_14_0::Env::API_TYPE] = type
          env[GrapeV0_14_0::Env::API_SUBTYPE] = subtype

          return unless VENDOR_VERSION_HEADER_REGEX =~ subtype

          env[GrapeV0_14_0::Env::API_VENDOR] = Regexp.last_match[1]
          env[GrapeV0_14_0::Env::API_VERSION] = Regexp.last_match[2]
          # weird that GrapeV0_14_0::Middleware::Formatter also does this
          env[GrapeV0_14_0::Env::API_FORMAT] = Regexp.last_match[3]
        end

        def fail_with_invalid_accept_header!(message)
          fail GrapeV0_14_0::Exceptions::InvalidAcceptHeader
            .new(message, error_headers)
        end

        def fail_with_invalid_version_header!(message)
          fail GrapeV0_14_0::Exceptions::InvalidVersionHeader
            .new(message, error_headers)
        end
        ...
        def rack_accept_header
          Rack::Accept::MediaType.new env[GrapeV0_14_0::Http::Headers::HTTP_ACCEPT]
        ...
        def error_headers
          cascade? ? { GrapeV0_14_0::Http::Headers::X_CASCADE => 'pass' } : {}
        end
