module GrapeV0_14_0
  module Validations
    class ParamsScope
      ...
      # @param attrs [Array] (see GrapeV0_14_0::DSL::Parameters#requires)
      ...
      def new_scope(attrs, optional = false, &block)
        ...
        if attrs.first && !optional
          ...
          fail GrapeV0_14_0::Exceptions::UnsupportedGroupTypeError.new unless [Array, Hash, JSON, Array[JSON]].include?(type)
        end
      ...
      def check_incompatible_option_values(values, default)
        ...
        fail GrapeV0_14_0::Exceptions::IncompatibleOptionValues.new(:default, default, :values, values)
      end
      ...
      def validate(type, options, attrs, doc_attrs)
        ...
        if validator_class
          ...
          fail GrapeV0_14_0::Exceptions::UnknownValidator.new(type)
        end
      end
      ...
      def validate_value_coercion(coerce_type, values)
        ...
        fail GrapeV0_14_0::Exceptions::IncompatibleOptionValues.new(:type, coerce_type, :values, values)
      end
    end
  end
end
