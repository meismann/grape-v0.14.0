...
module GrapeV0_14_0
  module Validations
    ...
    # parameters.
    #
    # GrapeV0_14_0 uses a number of tests and assertions to
    # work out exactly how a parameter should be handled,
    # based on the +type+ and +coerce_with+ options that
    # may be supplied to {GrapeV0_14_0::Dsl::Parameters#requires}
    # and {GrapeV0_14_0::Dsl::Parameters#optional}. The main
    ...
    module Types
      ...
      # or special logic in GrapeV0_14_0.
      PRIMITIVES = [
        # Numerical
        Integer,
        Float,
      ...
      # Types for which GrapeV0_14_0 provides special coercion
      ...
      # Is the given class a primitive type as recognized by GrapeV0_14_0?
      #
      # @param type [Class] type to check
      # @return [Boolean] whether or not the type is known by GrapeV0_14_0 as a valid
      ...
      # Does the given class implement a type system that GrapeV0_14_0
      ...
      # Does GrapeV0_14_0 provide special coercion and validation
