module GrapeV0_14_0
  module Validations
    module Types
      # This class is intended for use with GrapeV0_14_0 endpoint parameters that
      ...
      class MultipleTypeCoercer
        ...
        def call(value)
          ...
          # that GrapeV0_14_0 won't ask us again if the value is valid
          InvalidValue.new
        end
        ...
        # Due to GrapeV0_14_0's design this will in fact only be called
